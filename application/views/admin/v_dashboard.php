...
<head>
  ...
  <title>Dashboard | Admin - Yayasan Al Hidayah Sukmajaya Depok</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
      Dashboard Yayasan Al Hidayah
        <small></small>
      </h1>
      <ol class="breadcrumb" style="font-size:15px;">
        <li><a href="dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Dashboard</li>
        <li class="active">Yayasan Al Hidayah Sukmajaya Depok</li>
      </ol>
    </section>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y');?> Yayasan Al-Hidayah.</strong> All rights reserved.
  </footer>
</div>
